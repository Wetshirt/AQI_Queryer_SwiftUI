...
class OpenweatherAPIClient {
    ...
    private let apiKey = "c1f408d868324bb7a9ee55e7b111fa68"
    ...
    private func baseUrl(_ suffixURL: SuffixURL, param: String) -> URL {
        print("https://api.openweathermap.org/data/2.5/\(suffixURL.rawValue)?APPID=\(self.apiKey)&units=metric\(param)")
    ...
    private func getBaseRequest<T: Codable>(at cityId: String,
        ...
        let url = baseUrl(suffixURL, param: "&\(cityId)")
